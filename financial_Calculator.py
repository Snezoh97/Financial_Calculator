...
# Create GUI
root = tk.Tk()
root.title("Investment Calculator by Team Excellence")
...
clear_inv_button = tk.Button(root, text="Clear Investment", font=("Arial", 12), command=clear_investment)
clear_inv_button.grid(row=12, column=0, padx=10, pady=10)

clear_bond_button = tk.Button(root, text="Clear Bond", font=("Arial", 12), command=clear_bond)
clear_bond_button.grid(row=12, column=1, padx=10, pady=10)
